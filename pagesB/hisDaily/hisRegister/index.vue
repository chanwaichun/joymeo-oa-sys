<template>
	<view class="common-dashBoard-container" v-if="currentPage && currentFilter && pageFilter">
		...
		<RankCard :propsFilter="pageFilter" :showSort="false" :showRank="false" :showHeader="true" :showTime="true"
			:rankHeader="[
						{key:'clinicName',keyName:'诊所'},
						{key:'clinicCity',keyName:'城市'},
						{key:'saleName',keyName:'负责人'},
						{key:'logTime',keyName:'注册时间'}
					]" rankValue='salesRank' :titleMargin="0" api="getHisLogClinicNumDetail" :fetchByPage="true">
		</RankCard>
	</view>
</template>
